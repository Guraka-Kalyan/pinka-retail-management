...
// ── Month Picker — floating dropdown with year arrows + 4x3 grid ─────────────
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className={cn(
          "h-9 px-3 rounded-sm border text-sm font-bold flex items-center gap-1.5 transition-colors",
      ...
      {open && (
        <>
          ...
          <div className="absolute top-11 left-0 z-50 w-56 bg-card border border-border rounded-md shadow-xl p-3">
